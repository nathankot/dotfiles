...
ZSH_THEME_GIT_PROMPT_ADDED="%{$fg[green]%} ✚${make_reset}"
ZSH_THEME_GIT_PROMPT_MODIFIED="%{$fg[blue]%} ~${make_reset}"
ZSH_THEME_GIT_PROMPT_DELETED="%{$fg[red]%} ✖${make_reset}"
ZSH_THEME_GIT_PROMPT_RENAMED="%{$fg[magenta]%} ➜${make_reset}"
ZSH_THEME_GIT_PROMPT_UNMERGED="%{$fg[yellow]%} ═${make_reset}"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$fg[cyan]%} ✭${make_reset}"
